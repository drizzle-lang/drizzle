...
describe Drizzle::Object do
  it "correctly hashes objects to numerical values" do
    hello1 = Drizzle::Object::String.new "Hello World"
    hello2 = Drizzle::Object::String.new "Hello World"
    diff1 = Drizzle::Object::String.new "My name is freya"
    diff2 = Drizzle::Object::String.new "My name is freya"
